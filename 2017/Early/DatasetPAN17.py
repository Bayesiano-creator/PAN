...
class BasePAN17():
    ...
    def __init__(self, Dir, split, language, tokenizer, gender_dict, variety_dict, tweet_batch_size, max_seq_len, preprocess_text, tweets_portion):
        self.Dir          = Dir
        self.split        = split
        ...
        self.data      = self.get_tweets_in_batches(Dir, split, language, tweets_portion)
    ...
    def get_tweets_in_batches(self, Dir, split, language, tweets_portion):
        data   = []
        ...
        for author in self.authors:
            ...
            root         = tree.getroot()
            documents    = root[0]
            total_tweets = int(tweets_portion*len(documents))
